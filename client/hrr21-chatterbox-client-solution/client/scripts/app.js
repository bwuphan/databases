  ...
  send: function(message) {
    ...
    $.ajax({
      ...
      success: function (data) {
        console.log('message this' +this.data)
        console.log('data is here ' + JSON.stringify(data) + ' ' + data)
  ...
  fetch: function(animate) {
    $.ajax({
      ...
      success: function(data) {
        ...
        console.log('most recent ' + mostRecentMessage.id)
        console.log('app last message ' + app.lastMessageId);
